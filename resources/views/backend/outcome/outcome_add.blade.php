            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="card-title">Add Outcome Page</h4>
                        <br></br>
                       
                        <form id="myForm" method="POST" action="{{ route('outcome.store') }}">
                            @csrf

                            <div class="row mb-3">
                                <label for="example-text-input" class="col-sm-2 col-form-label">Outcome Type Name</label>
                                <div class="form-group col-sm-10">
                                    <input class="form-control" type="text" name="name" placeholder="Ex: Shopping">
                                </div>
                            </div>
                            ...
                            <center>
                                <input type="submit" class="btn btn-info waves-effect waves-light" value="Add Outcome">
                            </center>
                        </form>
