            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="card-title">Add Family Member Page</h4>
                        <br></br>
                        ...
                        <form id="myForm" method="POST" action="{{ route('member.store') }}" enctype="multipart/form-data">
                            ...
                            <center>
                                <input type="submit" class="btn btn-info waves-effect waves-light" value="Add Member">
                            </center>
                        </form>
    ...
    $(document).ready(function (){
        $('#myForm').validate({
            ...
            messages :{
                ...
                image: {
                    required : 'Please Select One Member Image',
                },
            },
            errorElement : 'span', 
